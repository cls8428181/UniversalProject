...
- (void)modifyPasswordSuccess {
    [kAppDelegate.navController popToRootViewControllerAnimated:false];
    [kAppDelegate.tabBarController turnToControllerIndex:3];
    [self logout:^(BOOL success, NSString *des) {
        [kAppDelegate presentLoginViewController];
    }];
}
